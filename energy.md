...
* As stated, the computational condition is controlled by the keywords in route section.
* The computational method such as Hartree-Fock or density functional theory (DFT) should be specified.
...
## Exercises
1. Write the input file for do the B3LYP calculation (with any basis set) for H2O molecule, and then run the Gaussian.
